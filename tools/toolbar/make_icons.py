...
G["app_groupdeck"]   = ("green", lambda i: f'<rect x="4" y="6" width="16" height="4" rx="1.5" {S(i,1.5)}/><rect x="4" y="14" width="16" height="4" rx="1.5" {S(i,1.5)}/><path d="M8 10V14M16 10V14" {S(i,1.8)}/>')
